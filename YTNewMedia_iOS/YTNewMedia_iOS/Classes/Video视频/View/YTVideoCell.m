...
+(instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    YTVideoCell * cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[YTVideoCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
    return cell;
}
...
-(void)setData:(YTVideoModel *)data{
    _data = data;
